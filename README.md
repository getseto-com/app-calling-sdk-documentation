...
| SDK | Best for | Guides |
| --- | --- | --- |
| Web | Browser applications that use the built-in web calling UI | [Getting Started](./docs/web/GETTING_STARTED.md), [Advanced Integration](./docs/web/ADVANCED_INTEGRATION.md) |
...
- The current public web integration path is centered on activation, presence, and admin outbound calling.
